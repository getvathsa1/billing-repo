package com.api.billing.logging;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* com.api.billing.controller.*.*(..)) || execution(* com.api.billing.services.*.*(..)) || execution(* com.api.billing.dao.*.*(..))")
	private void selectAll() {
	}

	@AfterReturning(pointcut = "execution(* com.api.billing.controller.*.*(..))", returning = "retVal")
	...
	@Pointcut("execution(* com.api.billing.controller.*.*(..))")
